...
/**
 * @file
 * API documentation for userpoints2.module
 */
 ...
 *   userpoints2_userpoints2_api() and the which has the following properties:
 ...
 *
 */
function hook_userpoints2_info() {
  return array(
    'expiry' => array(
      'description' => t('!Points have expired.', userpoints2_translation()),
 ...
 *
 * @see userpoints2_list_users().
 */
function hook_userpoints2_list_alter(&$output) {

}

/**
 * Allows to customize the output of a the my userpoints2 page.
 *
 * @param $output
 *   Render array with the content.
 *
 * @see userpoints2_list_transactions().
 */
function hook_userpoints2_list_transactions_alter(&$output) {
